...
@SecurityScheme(
    name = "AuthServer", // @SecurityRequirement nas rotas do controller
...
class SecurityConfig(val jwtTokenFilter: JwtTokenFilter) {
    ...
    @Bean
    fun filterChain(security: HttpSecurity, mvc: MvcRequestMatcher.Builder, jwtTokenFilter: JwtTokenFilter): DefaultSecurityFilterChain =
